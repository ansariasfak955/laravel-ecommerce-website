...
<div class="span9">
	...
	<div class="row">	  
			...
			<div class="span6">
				  ...
				  <div class="control-group">
					...
					<div class="controls">
						<form action="{{ route('cart.store') }}" method="post">
							@csrf
							<div>
								<input type="number" class="span1" name="qty" placeholder="Qty." value="{{ old('qty') }}"/>
								@if($errors->has('qty'))
									<p class="text-danger" style="color:red;">{{ $errors->first('qty')}}</p>
								@endif
							</div>
							...
							@else
								<button class="btn btn-large btn-primary pull-right"> <a style="color: #fff; text-decoration:none;" href="{{ route('user_login') }}">Add to cart
				...
				<hr class="soft"/>
				<h4>{{ $product->ProductDetail->total_items }} item in stock</h4>
